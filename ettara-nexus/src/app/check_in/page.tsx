...
import { CheckCircle, XCircle, Camera, UserCheck, Search, List, ChevronDown } from 'lucide-react';
...
export default function QRCodeCheckIn() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-md">
      ...
      <div className="mb-4">
        ...
        <div className="relative">
          <select
            ...
            onChange={(e) => setSelectedEvent(events.find(event => event.id === Number(e.target.value)) || events[0])}
      ...
      <div className="mb-4">
        <QRCode value={`Event: ${selectedEvent.name}`} />
      </div>
